...
// User's List
    ...
    */
       .get("/listofuser", UserController.UserList)
...
// Edit
     ...
     *   HTTP/1.1 500 Internal Server Error
     */
    .put("/profileUpdates/:userId", UserController.Update)
...
// GetOneUser
    ...
    *    HTTP/1.1 500 Internal Server Error
    */
    .get("/receiveUser/:userId", UserController.getOneUser)
...
// Remove User
    ...
    *    HTTP/1.1 500 Internal Server Error
    */
    .delete("/deleteUser/:userId", UserController.removeUser)
