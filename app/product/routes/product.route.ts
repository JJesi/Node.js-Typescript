...
import * as ProductMiddleware from "../middlewares/product.middleware";
import {UserController} from "../../user/controllers";

export const ProductRoute: express.Router = express.Router()
     ...
     *    HTTP/1.1 500 Internal Server Error
     */
    .post("/", [ProductMiddleware.CheckCreate], ProductController.Create)
    // Update Product
    /**
     ...
     *    HTTP/1.1 500 Internal Server Error
     */
    .put("/:id", [ProductMiddleware.CheckUpdate], ProductController.Update)
    // Delete Product
    /**
     ...
     *    HTTP/1.1 500 Internal Server Error
     */
    .delete("/:id", [ProductMiddleware.CheckDelete], ProductController.Delete)
     ...
     *    HTTP/1.1 500 Internal Server Error
     */
    .get("/userProductList/:userID",  ProductController.userProductList)
